export default function Lab1() {
  return (
    <div id="wd-lab1">
      <h1>Name: Dongni Zeng Section:52323</h1>
      <h2>Lab 1</h2>
      <h3>HTML Examples</h3>
      <div id="wd-h-tag">
        <h4>Heading Tags</h4>
...
tag to tell browsers to render the gaps.
      ...
      <div id="wd-lists">
        ...
        <ol id = "wd-your-favorite-recipe">
          <li>Cook two slices of bacon  </li>
          <li>Fry two eggs, add pepper on them</li>
          <li>Wash and cut two slice of tomato </li>
          <li>Toast two slices of bread</li>
          <li>Spread butter on the toast</li>
          <li>Assemble the sandwich</li>
          <li>Breakfast ready!</li>
        </ol>
      </div>
      <div id="wd-tables">
        <h4>Table Tag</h4>
      ...
      Please
      <a id="wd-github" href="https://github.com/ambirdZdn/kanbas-react-web-app">click here</a>
      to go to GitHub repo<br/>
    </div>
  );
}  