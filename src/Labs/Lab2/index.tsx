      ...
      <div id="wd-css-navigating-with-tabs">
        ...
        <ul className="nav nav-tabs">
          <li className="nav-item">
              <a className="nav-link active" href="#/Labs/Lab1">Lab1</a>
          </li>
          <li className="nav-item">
              <a className="nav-link" href="#/Labs/Lab2">Lab2</a>
          </li>
          <li className="nav-item">
              <a className="nav-link" href="#/Labs/Lab3">Lab3</a>
          </li>
          <li className="nav-item">
      ...
      <div id="wd-css-navigating-with-cards">
        ...
        <div className="card"
          ...
          <div className="card-body">
            ...
            <a href="https://www.khoury.northeastern.edu/people/jose-annunziato/" className="btn btn-primary">
              Go! Know more about this lovely professor
            </a>
          </div>
        </div>
      </div>
